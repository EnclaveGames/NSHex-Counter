class MainMenu extends Phaser.Scene {
    ...
    create() {
        ...
        this.buttonPlayer1 = new Button(EPT.world.centerX, 420, 'button-player1', this.clickPlayer1, this);
        this.buttonPlayer1.setOrigin(0.5, 0.5);

        this.buttonPlayer2 = new Button(EPT.world.centerX, 540, 'button-player2', this.clickPlayer2, this);
        this.buttonPlayer2.setOrigin(0.5, 0.5);
    ...
    initArmySelection(number) {
        this.selection = this.add.container(0, EPT.world.height);
		...
		this.selectionButtonBack = new Button(20, 25, 'button-back', this.clickBack, this, 'noframes').setOrigin(0, 0);
        ...
        this.selection.add([this.selectionBackground,this.selectionNavbar,this.selectionButtonBack,this.selectionTitle]);
        ...
        this.tweens.add({targets: this.selection, y: 0, duration: 750, ease: 'Cubic.easeOut' });
    }
        ...
        for(var w=0; w<5; w++) {
            for(var h=0; h<4; h++) {
                if(i<18) {
                    ...
                    var newButton = new Button(offsetLastLine+offsetLeft+h*160, offsetTop+w*170, 'tiles-hqs', function(i){
                        return function(){
                    ...
                    var newBorder = this.add.sprite(offsetLastLine+offsetLeft+h*160, offsetTop+w*170, 'hex-border-pattern');
                    var newLabel = this.add.sprite(offsetLastLine+offsetLeft+h*160, offsetTop+w*170+70, 'hex-labels', i+1).setScale(0.85);
    ...
    clickBack() {
        this.tweens.add({targets: this.selection, y: EPT.world.height, duration: 750, ease: 'Cubic.easeOut' });
